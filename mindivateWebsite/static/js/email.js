  ...
  className.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      if (needsRemoval) {
        ...
        //If currently clicked button is already activea
...
document.querySelector('.modal-form').addEventListener('submit', function() {
  var content = document.getElementById('text-input').innerHTML;
...
if (name) {
  ...
  h2Text.textContent = `Dear ${name}, it's great to hear from you`;
